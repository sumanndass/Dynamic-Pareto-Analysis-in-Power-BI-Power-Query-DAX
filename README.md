...
This project focuses on:
  <br> Robust data cleaning
  <br> Normalization of inconsistent identifiers
  <br>Dynamic ranking & cumulative calculations
  <br> Interactive Pareto thresholds
  <br> Industry-standard visualization patterns
